        ...
        <div class="card">
          <div class="card-body">
            <div class="d-flex flex-column align-items-center text-center">
              ...
              <div class="mt-3">
                <h4><span  class="font-weight-bold color_name">{{$u_pf->name}}</span> <a href=""><i class="far fa-edit"></i></a> </h4>
      ...
      <div class="col-lg-8">
        ...
        <div class="card">
          <div class="card-body">
            ...
            @if(Auth::user() != null && Auth::user()->id == $u_pf->id || Auth::user()->level == 0)
            <div class="row">
          ...
          <div class="col-sm-12">
            <div class="card">
              <div class="card-body">
                ...
                <p>{{$u_pf->name}} đã viết : {{$c_tr}} truyện</p>
                <p>{{$u_pf->name}} đã viết : {{$ctr_chap}} chương truyện</p>
