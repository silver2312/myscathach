...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Thêm Chương Truyện <strong style="font-size: x-large"><a style="text-decoration:none;" href="{{url('xemtruyen/'.$ch->bk_slug)}}">{{$ch->bk_name}}</a></strong></div>
                <div class="card-body">
