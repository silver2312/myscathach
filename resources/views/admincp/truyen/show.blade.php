...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">Danh sách chương của Truyện: <strong style="font-size: x-large"><a style="text-decoration:none;" href="{{url('xemtruyen/'.$cha->bk_slug)}}">{{$cha->bk_name}}</a></strong></div>
				<div class="card-body">
